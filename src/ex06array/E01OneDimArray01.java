...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		그래서 배열명(배열변수)는 주소값(참조값)을 할당받게 된다. 해당 주소를 통해 배열을 접근한다.
		 */
		...
		System.out.println("배열명(numArr)="+numArr);// [I@182decdb =>참조값(주소값)
		System.out.println("numArr 2번방의 값: "+numArr[2]); //30
		System.out.println("============================");
		...
		/*
		객체배열
			: 기본자료형을 저장하는 배열이 아닌, 객체의 참조겂을 저장할
			용도로 생성하는 배열이다.	사용법은 동일하다.
		 */
		...
		초기값의 개수를 통해 크기를 결정할 수 있으므로 이런 경우
		크기는 생략하도록 약속되어있다.
		 */

...
public class Ex02PreDefineException {
	...
	public static void main(String[] args)  {	
		...
		/*
		ClassCastException : 형변환이 불간으한 경우 발생되는 예외
		 */
		Object object = new Object(); //String과 관련이 없는 순수한 Object 객체
		try {
			String strObject = (String)object; // 때문에 형변환 불가능
		...
		System.out.println("CalssCastException 발생 후");
	...
	/*
	String객체가 인자로 전달되면서 매개변수를 통해 Object로 형변환
	되었기 때문에 여기에서 상속관계가 확인되어 매개변수 o는 
	String으로 형변환이 가능해진다.
	 */
	public static boolean myClassCasting(Object o) {
		/*
		instanceof => 업캐스팅된 형태가 원래 어떤 타입이었는지 알아봐주는 것
		
		위의 예제에서 보듯 원래 String이었던 str이 myClassCasting을 통해 
		Object로 자동업캐스팅이 이루어지고
		아래의 instanceof를 통해 Object로 업캐스팅이 이루어지기 전 
		String타입이었는지 확인하고있다.

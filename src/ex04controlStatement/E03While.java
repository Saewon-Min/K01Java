...
public class E03While {
	...
	public static void main(String[] args) {
		...
		while(dan<=9) { // 단은 2~9까지 증가한다.
			int su =1; // 수(하나의 단을 출력한 후 단이 증가하면 수는 1로 초기화된다.)
			while(su<=9) { // 수는 1~9까지 증가한다.
				
				// 서식에 맞춰 출력할때는 printf문이 좀 더 유리하다.
				//System.out.print(dan+"*"+su+"="+(dan*su)); => 에러아님
				System.out.printf("%-2d*%-2d=%2d", dan,su,(dan*su)); 
				// -> 보기좋게 정렬하기 위해서 d앞에 -2를 붙임
				System.out.print(" ");
				su++;
			}
			System.out.println();
		...
		/*
		시나리오] 1부터 100까지의 정수중 3의배수이거나 4의배수인
		...
		System.out.println("1~100사이 3 또는 4 배수의 합: "+ total);

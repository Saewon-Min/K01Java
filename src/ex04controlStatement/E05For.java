...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		시나리오] for문을 이용하여 1~10사이의 정수 중 2의배수의 합을
		구하는 프로그램을 작성하시오.
		 */
		int total = 0;
		...
		total = 0;
		for (int i = 0; i <=10; i+=2) { // 복합대입연산자를 사용이 가능함.
			total += i;
		}
		...
		/*
		for문으로 무한루프를 만들떄 사용. 일반적으로는 while을 사용함.
		while문에서의 무한루프 => while(true){}
		 */
		int a = 1;
//		for(;;) {
...
//		}
		 ...
		 */
		for (int j = 0; j <=5; j++); {
			System.out.println("for문 끝나기 전에 ;쓰는거 금지"); 
			// -> 위의 for문과 별개로 딱 한번만 진행됨
		}
		...
		System.out.println("for문 밖에서의 i값 = "+i); // i가 마지막으로 증가한 뒤의 값:6

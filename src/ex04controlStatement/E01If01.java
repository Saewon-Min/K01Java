...
//		}
		...
		if(조건식); => 조건식에 상관없이 다음 문장이 실행되는 형태로
			세미콜론(;)은 문장의 끝을 나타내므로 사용에 주의해야 한다.
		 */
		if (num%2 != 0);
		{
		...
		/*
		조건검사 후 실행할 문장이 1개인 경우에는 {} 중괄호를 생략할수있다.
		단, 실행문이 2개 이상인 경우에는 한문장만 실행되므로 반드시 중괄호를
		작성해야 한다.
		 */
		if (num%2 ==0) 
			System.out.println("\n"+num+"은 짝수이다");
...
//		System.out.println("입력한 문자: "+ (char)asciiCode);
		...
		/*
		아스키코드값을 알고 있을때의 구현방법
		'0' => 48
		'9' => 57 이므로 해당 구간안에 있다면 숫자로 판단할수있다.

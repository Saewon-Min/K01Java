...
public class AnimalDog extends Animal{
	...
	public AnimalDog(String species,int age,String gender,String dogKind,String name) {
		...
		/*
		자식 클래스에서는 반드시 부모 클래스의 객체를 먼저 생성해야한다.
		여기서 super()는 부모클래스의 생성자 메소드를 호출하는
		용도로 사용된다.
		 */
...
public class AnimalDog extends Animal{
	...
	public void showDog() {
		System.out.printf("\n강아지의 종류는 %s이고 이름은 %s이다.",dogKind,name);
	}
	
	public AnimalDog(String species,int age,String gender,String _dogKind,String _name) {
		super(species, age,gender);

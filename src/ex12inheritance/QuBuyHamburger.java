...
class Burger {
	...
	//인자생성자
	public Burger(String burgerName,int price,String patty,String sauce,String vagetable) {
	...
	public void bugerInfo() {
		...
		System.out.println("식재료:"+this.patty+", "+this.sauce+", "+this.vagetable);
...
class HamburgerPrice {
	...
	//인자생성자
	public HamburgerPrice(Burger burgers) {
		burger = new Burger(burgers.burgerName,burgers.price,burgers.patty,burgers.sauce,burgers.vagetable);
		burger.bugerInfo();
	}
	//기본가격계산
	public int getPrice() {
...
class SetPrice extends HamburgerPrice {	
	...
	public void showPrice() {
		//super.showPrice();
		System.out.println("세트결제금액 : "+(getPrice()-500));

...
해당 문제는 상속을 통해 구현하는것이 아니라 구성관계를 
이용하여 해결한다. Point 클래스를 기반으로 원을 의미하는 
Circle클래스를 정의하자. 그리고 Circle클래스를 기반으로 
Ring클래스를 정의하자.
...
class Circle{	
	...
	public void showCircleInfo() {
		/*
		반지름은 멤버변수를 통해 즉시 출력하고, 중심점은 Point객체의 멤버메소드를
		호출하여 출력한다.
		 */
...
class Ring{
	...
	public void showRingInfo() {
		/*
		상속관계가 아니므로 각각의 멤버변수(Circle객체)를 통해 멤버메소드를
		호출해야 한다.
		 */

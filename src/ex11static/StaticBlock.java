...
static 블럭
	...
	실행되다가 static 블럭이 있는 클래스가 객체화될때 실행된다.
...
public class StaticBlock {
	...
	/*
	해당 파일안에 static 블럭이 있으므로 main보다 static이 먼저 실행됨
	 */
	
	/*
	main 메소드가 외부 파일에 있을경우 테스트를 위해 아래 부분은 주석 처리 후
	실행해본다. E02예제를 실행하면 된다.
	 */

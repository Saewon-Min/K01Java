...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 방법 1 : float를 long으로 형변환후 연산하거나
		 방법 2 : 계산결과 전체를 long형으로 명시적(강제) 형변환한다.
		 */
		long result2 = long1 + (long)float1 ; //float1을 long으로 바꾸어도 데이터 손실이 없기 때문에 가능함
		...
		float f4 = (float)3.14; // 형변환후 대입 가능(권장사항 아님)
		System.out.println("f4 = " + f4);
		
		float f5 = 3.14F; // 접미사 f를 통해 float임을 표현한다.(권장사항)

...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		 ...
		 */
		System.out.println("str1의 두번재 문자 : " + str1.charAt(1));
		System.out.println("str2의 두번재 문자 : " + str2.charAt(1));
		 ...
		 */
		// -(하이픈)의 위치를 찾아 +1하면 성별에 해당하는 문자를 가져올수있다.
		...
		/*
		11] lastIndexOf()
			: 사용법은 indexOf()와 동일하나 문자열의 뒤에서부터 문자열을
			찹아서 인덱스를 반환한다.
		 */
		...
		*/
		...
		14] substring(시작,끝) 
			...
			사용1 : substring(index) : 이 경우 index부터 문자열의 끝까지를 잘라서 반환한다.
			사용2 : substring(index1,index2) : 인덱스에 해당하는 부분만 잘라서 반환한다.
		 */

...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		/*
		아래 2개의 컬렉션은 내부적인 자료구조만 다를뿐 구현방법은 동일하다.
		컬렉션 생성시 Student형의 타입 매개변수를 사용한다.
		ArrayList<Student> list2 = new ArrayList<Student>();
		*/
		LinkedList<Student> list2 = new LinkedList<Student>();
			
		// 개발자가 정의한 인스턴스 생성(외부 패키지에 정의함)
...
//			student.showInfo();
		...
		// 인덱스를 통한 삭제
		//System.out.println("삭제된 객체의 이름 : " + list2.remove(2).name); => 에러발생

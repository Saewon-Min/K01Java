...
내부멤버클래스
	...
	- 외부 클래스의 모든 멤버(정적 혹은 인스턴스형)를 사용할수있다.
...
class OuterMember{
	...
	class InnerMember{
		...
		void innerInstanceMethod() {
			...
			OuterMember.this.sameVar = Integer.MAX_VALUE;
		}
		
		/*
		내부클래스에서는 static멤버를 선언할 수 있다.
		단, 상수인 경우에만 허용된다.
		 */
...
public class E01InnerMemberClass {
	public static void main(String[] args) {
		...
		/*
		외부클래스의 인스턴스를 먼저 생성한 후 내부클래스의 인스턴스를 생성한다.
		 */
